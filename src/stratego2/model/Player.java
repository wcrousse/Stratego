...
public class Player {
    ...
    /**
     * gets a data structure representing a Stratego move. The Move object returned
     * contains no Piece object, only coordinates of the piece. The method is 
     * ensured to return a start square that contains a piece. No further guarantees 
     * are made as to the legality of the proposed move however. These checks are
     * the responsibility of the calling class.
     * @param board a representation of the game state just prior to the move
     * to be made 
     * @return a Move object, a simple data structure which has fields and accessors
     * startRow, StartColumn, destinationRow, and destination column, indicating,
     * the location of the piece intended to be moved before and after the move is made.
     * 
     */
    ...
    /**
     * retrieves an integer array representation of initial army
     * positions. uses it to generate army. 
